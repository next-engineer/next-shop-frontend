          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="bg-gray-900 rounded-2xl p-8 shadow-2xl border border-gray-800">
              ...
              <div className="mt-8 text-center">
                <p className="text-gray-400 mb-4">계정이 없으신가요?</p>
                <Link href="/signup">
                  <Button
                      variant="outline"
        ...
        {showForgotPassword && (
            <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
              <div className="bg-gray-900 rounded-2xl p-8 max-w-md w-full">
                ...
                <Input type="email" placeholder="이메일을 입력하세요" className="bg-gray-800 border-gray-700 text-white mb-4" />
                <div className="flex space-x-3">
                  ...
                  <Button className="flex-1 bg-white text-black hover:bg-gray-200">전송</Button>
                </div>
              </div>
            </div>
        )}
            ...
            <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
              <div className="bg-gray-900 rounded-2xl p-8 max-w-md w-full">
                ...
                <div className="space-y-4">
                  <Input type="email" placeholder={`${showSocialLogin} 이메일`} className="bg-gray-800 border-gray-700 text-white" />
                  <Input type="password" placeholder="비밀번호" className="bg-gray-800 border-gray-700 text-white" />
                  <Button className="w-full bg-white text-black hover:bg-gray-200">로그인</Button>
                  <Button onClick={() => setShowSocialLogin(null)} variant="outline" className="w-full border-gray-600 text-white hover:bg-gray-800 bg-transparent">
                    취소
                  </Button>
                </div>
              </div>
